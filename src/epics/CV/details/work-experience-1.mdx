...
React.js, Node.js, TypeScript, CSS (Tailwind, Mantine), Elixir, GCP, Terraform, Kubernetes, SQL, ArgoCD, Github Action, Vitest, Playwright
...
React.js, Node.js, TypeScript, CSS (Styled Components, MUI), Elixir, AWS, Terraform, Kubernetes, SQL, ArgoCD, Github Action, Jest, Playwright